...
pub struct OverviewDashboardDTO {
    network_graph: NetworkGraphDTO,
}

// impl OverviewDashboardDTO {
...
// }
//
// impl Encoder for OverviewDashboardDTO {
...
// }
//
// impl Decoder for OverviewDashboardDTO {
...
//
//         let network_graph_request = OverviewDashboardRequestDTO::new(
//             START_DATE_TIME,
//             END_DATE_TIME,
//         );
//
...
//             END_DATE_TIME,
//         );
//         assert_eq!(network_graph_request, OverviewDashboardRequestDTO::decode(&network_graph_request.encode()));
//     }
// }