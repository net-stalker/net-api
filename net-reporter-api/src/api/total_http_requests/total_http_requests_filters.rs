...
pub struct TotalHttpRequestsFiltersDTO {
...
impl API for TotalHttpRequestsFiltersDTO { }

impl TotalHttpRequestsFiltersDTO {
    pub fn new(
        http_methods: &[String],
        include_http_methods_mode: Option<bool>,
        endpoints: &[String],
...
impl Encoder for TotalHttpRequestsFiltersDTO {
...
impl Decoder for TotalHttpRequestsFiltersDTO {
...
impl Typed for TotalHttpRequestsFiltersDTO {
...
mod tests {
    ...
    fn reader_correctly_read_encoded_nbpe_filters_0() {
        ...
        let network_bandwidth_filters = TotalHttpRequestsFiltersDTO::new(
            &[],
            None,
            &endpoints,
            Some(INCLUDE_ENDPOINTS_MODE),
    ...
    fn endec_nbpe_filters() {
        ...
        let network_bandwidth_filters: TotalHttpRequestsFiltersDTO = TotalHttpRequestsFiltersDTO::new(
            &http_methods,
            Some(INCLUDE_PROTOCOLS_MODE),
            &endpoints,
            Some(INCLUDE_ENDPOINTS_MODE),
        ...
        assert_eq!(network_bandwidth_filters, TotalHttpRequestsFiltersDTO::decode(&network_bandwidth_filters.encode()));
    }
}